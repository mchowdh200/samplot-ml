...
aws s3 cp s3://layerlab/samplot-ml/1kg/duphold_callset/bed/training_regions_duphold.bed $data_dir/bed
training_regions=$data_dir/bed/training_regions_duphold.bed
